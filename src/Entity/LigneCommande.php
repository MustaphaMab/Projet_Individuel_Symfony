...
class LigneCommande
{
    ...
    private ?Commande $Id_commmande = null;
    ...
    public function getIdCommmande(): ?Commande
    {
        return $this->Id_commmande;
    }

    public function setIdCommmande(?Commande $Id_commmande): static
    {
        $this->Id_commmande = $Id_commmande;
